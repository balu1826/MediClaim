...
public class FraudScoringService : IFraudScoringService
{
    ...
    public FraudScoringService(IEnumerable<IFraudRuleEvaluator> evaluators)
    {
                ...
                CancellationToken cancellationToken)
    {
        ...
        {
            var score = await evaluator.EvaluateAsync(claim, cancellationToken);
            totalScore += score;
            if (score > 0)
            {
