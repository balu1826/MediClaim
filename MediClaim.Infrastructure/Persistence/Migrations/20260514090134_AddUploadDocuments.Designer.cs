...
namespace MediClaim.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260514090134_AddUploadDocuments")]
    partial class AddUploadDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediClaim.Domain.Entities.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("MediClaim.Domain.Entities.JobExecutionLog", b =>
                {
                    b.Property<long>("JobExecutionLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("JobExecutionLogId"));
            ...
            modelBuilder.Entity("MediClaim.Domain.Entities.Report", b =>
                {
                    ...
                    b.Property<decimal>("AverageProcessingTimeHours")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
